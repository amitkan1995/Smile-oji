...
from .code.nn.conv import LeNet
...
# construct the argument parser and parse the arguments (Add -d <path of dataset> -m <path of output model>
...
# loop over the input images for loading 
