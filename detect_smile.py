...
# construct the argument parse and parse the arguments (<excuting statement> -c <Path to face casacade.xml> -m <Path of pre-trained Smile detector>)
ap = argparse.ArgumentParser()
ap.add_argument('-c', '--cascade', required=True, help='path to where the face cascade resides')
ap.add_argument('-m', '--model', required=True, help='path to the pre-trained smile detector CNN')
ap.add_argument('-v', '--video', help='path to the (optional) video file') #To detect smile on video 
